...
# Play Surface
playSurface = pygame.display.set_mode((640, 320))
...
def showScore(choice=1):
    ...
    Ssurf = SFont.render("Рахунок :  {0}".format(score), True, black)
...
while True:
    ...
    if snakePos == foodPos:
        ...
        snakeBody.pop()
    if foodSpawn == False:
        foodPos = [random.randrange(1, 640 // 10) * delta, random.randrange(1, height // 10) * delta]
        foodSpawn = True
